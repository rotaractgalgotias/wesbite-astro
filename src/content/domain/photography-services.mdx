...
### Objectives:
- Event Coverage: We document club meetings, service projects, and special events to create visual records of our activities. The entire coverage of any event from the videos , photos to audio is recorded by the Photography Team. We maintain the drive links of the entire coverage of the event and bestow the required files.
...
- Photowalks: We conduct Photowalks , where we visit various aesthetic locations and capture the beautyt of the nature. We train our members with the art of Photography during the walk and encourage them to learn and explore more.
